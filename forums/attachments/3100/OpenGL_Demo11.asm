...
PositionLight Color4  <0.0f,0.0f,4.0f,1.0f>		;Position light just behind the camera, facing outwards

  ;Data for our tetrahedron
  Translate1 Vec3 <0.0f,0.0f,-4.0f>   ;Translation from (0,0,0) to origin of tetrahedron
...
DrawGLScene proc
	...
	invoke glBegin,GL_TRIANGLES									; Drawing using triangles
		...
		invoke glNormal3f,TriPoint4.x,TriPoint4.y,TriPoint4.z
