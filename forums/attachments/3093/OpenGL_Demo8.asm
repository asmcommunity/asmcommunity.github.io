...
LOCAL texid, pxm
	...
	.if $inv(GetFileAttributes,szFileName) !=-1
		...
		.if eax==0			
			...
			;For now, we'll assume one of two possible pixel formats
			;But we really should try harder
			;Anyway its enough for this demo
			mov edx,pxm
...
ReloadTextures proc	
	mov MyTextureID,$inv(LoadTexture,"Data/Tile1.jpg")
